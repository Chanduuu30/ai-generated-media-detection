...
OUTPUT_PATH = PROJECT_ROOT / "data/processed/image_features.csv"
ERROR_PATH = PROJECT_ROOT / "data/processed/feature_extraction_errors.csv"
...
def main():
    ...
    for index, row in df.iterrows():
        ...
        # Convert manifest path into an absolute project path
        ...
        try:
            ...
            for feature_index, value in enumerate(features):
                feature_row[f"feature_{feature_index}"] = value
