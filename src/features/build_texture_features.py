...
OUTPUT_PATH = PROJECT_ROOT / "data/processed/texture_features.csv"
ERROR_PATH = PROJECT_ROOT / "data/processed/texture_feature_errors.csv"
    ...
    for index, row in df.iterrows():
        ...
        try:
            ...
            for feature_index, value in enumerate(features):
                feature_row[
                    f"texture_feature_{feature_index}"
                ] = value
